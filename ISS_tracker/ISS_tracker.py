...
home = ephem.Observer() #must be updated for current location
home.lon = '86.9290' #+E
home.lat = '40.4230' #+N
home.elevation = 185 #meters

# get the latest ISS TLE dat from http://spaceflight.nasa.gov/realdata/sighting
...
#note make sure in set up that the stepper is in the right cardinal orientation of the ISS
